...
<div
  class="absolute bottom-0 left-0 w-full border-t md:border-t-0 md:border-transparent md:bg-vert-light-gradient bg-white md:!bg-transparent pt-2">
  <div class="relative mx-2 gap-3 mb-2 lg:mx-auto lg:max-w-2xl xl:max-w-3xl">
    <div
      ...
      <div
        ...
        <textarea
          id="textarea"
          class="m-0 w-full resize-none border-0 bg-transparent p-0 pr-7 focus:ring-0 outline-none focus-visible:ring-0 pl-2 md:pl-0"
          rows="1"
        ...
        <button
          class="absolute p-1 rounded-md text-gray-500 bottom-1.5 md:bottom-2.5 hover:bg-gray-100 disabled:hover:bg-transparent right-1 md:right-2 disabled:opacity-40"
          ><svg
            stroke="currentColor"
            fill="none"
            stroke-width="2"
